...
var transactionCtrlStub = {
  ...
  upsert: 'transactionCtrl.upsert',
  patch: 'transactionCtrl.patch',
...
describe('Transaction API Router:', function() {
  ...
  describe('PUT /api/transactions/:id', function() {
    it('should route to transaction.controller.upsert', function() {
      expect(routerStub.put
        .withArgs('/:id', 'transactionCtrl.upsert')
        ).to.have.been.calledOnce;
    });
  });

  describe('PATCH /api/transactions/:id', function() {
    it('should route to transaction.controller.patch', function() {
      expect(routerStub.patch
        .withArgs('/:id', 'transactionCtrl.patch')
        ).to.have.been.calledOnce;
    });
  });
