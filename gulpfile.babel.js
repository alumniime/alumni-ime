// Generated on 2018-03-25 using generator-angular-fullstack 4.2.0
"use strict";
...
gulp.task("serve:debug", (cb) => {
  runSequence(
    ["clean:tmp", "lint:scripts", "inject", "copy:fonts:dev", "env:all"],
    "webpack:dev",
...
gulp.task("build", (cb) => {
  runSequence(
    ...
    "inject",
    "transpile:server",
    ["build:images", "build:imagesUpload"],
    [
      "copy:extras",
      "copy:assets",
      "copy:fonts:dist",
...
gulp.task("build:images", () => {
  return gulp
    .src([paths.client.images, "!" + paths.client.imagesUpload])
    .pipe(
      plugins.imagemin([
...
gulp.task("copy:server", () => {
  return gulp
    .src(["package.json", `${serverPath}/**/*.html`], { cwdbase: true })
